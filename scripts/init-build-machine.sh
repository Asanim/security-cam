...
sudo apt update
sudo apt install -y libnvinfer-dev libnvinfer-plugin-dev libnvonnxparsers-dev libnvparsers-dev tensorrt tensorrt-libs python3-libnvinfer-dev libjsoncpp-dev cuda-cudart-dev-11-4 cuda-cupti-dev-11-4 cuda-driver-dev-11-4 cuda-libraries-dev-11-4 cuda-nvml-dev-11-4 cuda-nvrtc-dev-11-4 libcusolver-dev-11-4 libpoco-dev
